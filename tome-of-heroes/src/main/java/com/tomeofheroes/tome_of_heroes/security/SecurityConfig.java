    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationFilter jwtAuthenticationFilter) throws Exception {
        http
            ...
            .authorizeHttpRequests(requests -> requests
                ...
                // Permite acesso aos endpoints que começam com "/admin/" apenas para usuários com a role "ADMIN"
                .requestMatchers("/admin/**").hasRole("ADMIN")
                // Permite acesso aos endpoints que começam com "/user/" apenas para usuários com a role "USER"
        ...
        // Adiciona o filtro de autenticação JWT antes do filtro de autenticação de usuário e senha
